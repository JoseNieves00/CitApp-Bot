...
namespace CitAppBot
{
    public partial class FrmLogin : Form
    {
        ...
        private AdministradorBLL adminBLL = new AdministradorBLL();
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            bool acceso = adminBLL.Login(nombre, contrasena);

            if (acceso)
            {
                MessageBox.Show("Bienvenido administrador.");
                FrmPrincipal frm = new FrmPrincipal(); // Tu ventana principal
                frm.Show();
